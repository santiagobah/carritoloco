...
echo "🔧 Arreglando handlers con código actualizado..."

# Fix product_handler.go
cat > goo/handlers/product_handler.go << 'EOF'
package handlers
...
echo "✅ Archivo product_handler.go actualizado"

# Remove duplicate model files if they exist
echo "🧹 Limpiando archivos duplicados..."
rm -f goo/models/product.go goo/models/sale.go goo/models/sale_item.go
